    ...
    if($password != ''){
        ...
        if($data = $result->fetch()){
            if($data['email_valid'] == 1) {
                ...
                $subject = trim('Vérification de votre compte.');
                $message = '
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr style="text-align:center">
                                    <td class="content-block" itemprop="handler" itemscope itemtype="https://schema.org/HttpActionHandler" valign="top">
                                        <a href="'.$domaine_admin.'/validation/?token='.$mailToken.'" class="btn-primary" itemprop="url">Confirmer mon email</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block" valign="top">
                                ...
                                <tr>
                                    <td valign="top">Cordialement, <br/>AEEK KASSERE</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
    ...
    <table width="100%">
        <tr>
            <td class="aligncenter content-block" align="center" valign="top">
                ...
                Copyright © 2022 AEEK KASSERE. Tous droits réservés.
            </td>
        </tr>
    </table>
</div>
...
';
                ...
                $_SESSION['_valid'] = $tab;
                header('location:' .$domaine_admin.'/mail-no-valid');
                exit();
            }
